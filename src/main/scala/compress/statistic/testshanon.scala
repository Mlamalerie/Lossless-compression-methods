...
object testshanon {
	def main(args: Array[String]): Unit = {
		...
		println("###############################################################")
		var h = new Huffman[Char]("HOURRAHOURRAHOURRRRA") //println("...",h.orderedCounts.reverse.map( leaf => EncodingLeaf(leaf._2,leaf._1) ).toList)
		...
		println("###############################################################\n")
		var h1 = new ShannonFano[Char]("HOURRAHOURRAHOURRRRA") //println("...",h.orderedCounts.reverse.map( leaf => EncodingLeaf(leaf._2,leaf._1) ).toList)
